...
> **김동혁**: 외부 API와의 통신을 맡아 예상치 못한 문제들이 생길 때마다, 깊은 고민과 빠른 행동으로 잘 처리하는 모습에서 문제에 대응하는 방법을 어깨 너머로 배울 수 있었습니다. 앞으로의 프로젝트에서는 더욱 더 많은 문제들이 발생할텐데, 그때도 우진님과과 함께 잘 해결해가고 싶습니다!
>
